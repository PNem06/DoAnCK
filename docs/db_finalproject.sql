...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 24, 2026 at 03:49 PM
...
--
ALTER TABLE `tbl_director`
  MODIFY `Directot_ID` int(10) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `tbl_award_director`
  ...
  ADD CONSTRAINT `fk_ad_director` FOREIGN KEY (`Director_ID`) REFERENCES `tbl_director` (`Directot_ID`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `tbl_movie-director`
  ADD CONSTRAINT `fk_md_director` FOREIGN KEY (`Director_ID`) REFERENCES `tbl_director` (`Directot_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
